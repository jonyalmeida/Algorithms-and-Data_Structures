...
describe("LinkedList", () => {
    ...
    describe("LinkedList Methods", () => {
        it('Should have methods named "addToTail", "removeTail", "addToHead", "removeHead", "contains", "get", "set", "insert", "remove", and "getLength"', () => {
            ...
            expect(linkedList.getLength).to.be.a("function");
        });
        ...
        describe("getLength", () => {
            it("Should return the length of the list", () => {
                expect(linkedList.getLength()).to.equal(0);
                linkedList.addToTail("A");
                expect(linkedList.getLength()).to.equal(1);
                linkedList.addToTail("B");
